...
//	      System.out.println(noOfPages);
		...
		// We want all the titles of the books
	      ...
	      //we want , seprated list of all the country of authors who have written the books?
...
//
//	      Map<Integer, List<Book>> mapOfBookPerYear =
//	    		  allBooks.stream().collect(groupingBy(Book::getYear));
//	      
//	      mapOfBookPerYear.forEach((year,listOfBooks)->System.out.println(year+" : "+ listOfBooks));
//	      
		

	      Map<Integer,Long> mapOfBookPerYear =
	    		  allBooks.stream().collect(groupingBy(Book::getYear, counting()));
	      
	      mapOfBookPerYear.forEach((year,noOfBooks)->System.out.println(year+" : "+ noOfBooks));
	      
	      
	      //keyset vs entrySet(better performance)
